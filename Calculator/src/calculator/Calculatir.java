 ...
 * @author Awil
 */
public class Calculatir extends javax.swing.JFrame {
    ...
    public void enable()
    {
        ...
        jRadioButton1.setEnabled(false);//on buttun disabled
        jRadioButton2.setEnabled(true);// off buttun enbled
    ...
    public void disable()
    {
        ...
        jRadioButton2.setEnabled(false);//OFF BUTTON  DIS ABLE
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:awil editing
        //jTextField1.setText(jTextField1.getText() + "+");
       num = Double.parseDouble(jTextField1.getText());
       calculation = 1;
       jTextField1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Calculatir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Calculatir().setVisible(true);
            }
        });
    }
